...
import { userRoleSchema } from "@kidscare/shared-schemas";
let UsersController = (() => {
    let _classDecorators = [Controller('users'), UseGuards(TenantGuard), Roles('SUPER_ADMIN', 'ADMIN')];
    ...
    var UsersController = class {
        ...
        static {
            ...
            _invite_decorators = [Post(), HttpCode(201)];
        ...
        async list(tenantId, roleQuery) {
            const role = roleQuery ? userRoleSchema.parse(roleQuery) : undefined;
            return this.usersService.list(tenantId, role);
        }
        async invite(tenantId, body) {
