...
let AttendanceRepository = (() => {
    ...
    var AttendanceRepository = class {
        ...
        static {
            ...
            AttendanceRepository = _classThis = _classDescriptor.value;
        ...
        async findByDate(tenantId, date) {
            return this.prisma.withTenant((client) => client.attendance.findMany({
                where: { tenantId, date },
                orderBy: { createdAt: 'asc' },
            }));
        }
        async findByStudentAndDate(tenantId, studentId, date) {
            return this.prisma.withTenant((client) => client.attendance.findUnique({
                where: {
        ...
        async upsert(tenantId, studentId, date, data) {
            ...
            return this.prisma.withTenant((client) => client.attendance.upsert({
                where: {
                    tenantId_studentId_date: {
                        tenantId,
                        studentId,
    ...
    return AttendanceRepository = _classThis;
})();
