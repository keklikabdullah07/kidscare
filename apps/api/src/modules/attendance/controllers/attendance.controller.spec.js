...
const mockEntity = new Attendance('att-1', 't-1', 's-1', '2026-09-15', 'PRESENT', '08:30', 'Ahmet Yılmaz', null, null, null, null, null, '2026-09-15T08:30:00.000Z', '2026-09-15T08:30:00.000Z');
describe('AttendanceController', () => {
    ...
    describe('checkOut', () => {
        it('delegates check-out to service', async () => {
            const leftEntity = new Attendance('att-1', 't-1', 's-1', '2026-09-15', 'LEFT', '08:30', 'Baba', '17:00', 'Anne', 'ec-1', null, null, '2026-09-15T08:30:00.000Z', '2026-09-15T17:00:00.000Z');
    ...
    describe('update', () => {
        it('updates attendance status', async () => {
            const excusedEntity = new Attendance('att-1', 't-1', 's-1', '2026-09-15', 'EXCUSED', null, null, null, null, null, null, 'İzinli', '2026-09-15T08:30:00.000Z', '2026-09-15T08:30:00.000Z');
