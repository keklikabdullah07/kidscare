...
let TenantsRepository = (() => {
    ...
    let _classThis;
    var TenantsRepository = class {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            TenantsRepository = _classThis = _classDescriptor.value;
        ...
        async findById(tenantId) {
            return this.prisma.withTenant((client) => client.tenant.findUnique({ where: { id: tenantId } }));
        }
        async update(tenantId, data) {
            return this.prisma.withTenant((client) => client.tenant.update({ where: { id: tenantId }, data }));
        }
    };
    return TenantsRepository = _classThis;
})();
