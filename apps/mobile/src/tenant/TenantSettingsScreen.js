...
export function TenantSettingsScreen() {
    ...
    async function handleSave() {
        if (!tenant || saving || name === tenant.name)
            return;
        setSaving(true);
        setErrorMsg(null);
        try {
    ...
    return (<ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.card}>
        ...
        <Row label="Durum" value={<View style={styles.badge}>
              <Text style={styles.badgeText}>{tenant.status}</Text>
            </View>}/>
        <Row label="Oluşturuldu" value={<Text style={styles.valueText}>
      ...
      <View style={styles.card}>
        ...
        <TouchableOpacity style={[styles.button, (saving || name === tenant.name) && styles.buttonDisabled]} onPress={() => void handleSave()} disabled={saving || name === tenant.name}>
