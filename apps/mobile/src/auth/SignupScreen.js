    ...
    return (<KeyboardAvoidingView style={styles.flex} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.card}>
          ...
          <TextInput style={styles.input} value={name} onChangeText={setName} placeholder="Yeni Kreş" editable={!submitting}/>

          <Text style={styles.label}>
            Kreş slug <Text style={styles.hint}>(küçük harf, tire)</Text>
          </Text>
          <TextInput style={styles.input} value={slug} onChangeText={setSlug} autoCapitalize="none" autoCorrect={false} placeholder="yeni-kres" editable={!submitting}/>
