...
export interface CreateActivityModalProps {
  visible: boolean;
  onClose: () => void;
  onCreated: (newPost: ActivityPost) => void;
  defaultClassroom?: string | undefined;
}
...
export function CreateActivityModal({
  ...
  onClose,
  onCreated,
  defaultClassroom = 'Papatyalar Sınıfı',
  ...
  const [selectedUrls, setSelectedUrls] = useState<string[]>(
    PRESET_PHOTOS[0]?.url ? [PRESET_PHOTOS[0].url] : [],
  );
    ...
    >
      <SafeAreaView style={styles.safeArea}>
        ...
        <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
          ...
          <TextInput
            style={styles.input}
            placeholder="Örn: 🎨 Suluboya ve Renkli Yapraklar"
            value={title}
          ...
          <TextInput
            ...
            placeholder="Çocuklar bugün neler yaptı, neler öğrendi?"
            value={description}
            ...
            {PRESET_PHOTOS.map((preset, idx) => {
              ...
              return (
                <TouchableOpacity
                  ...
                  onPress={() => togglePreset(preset.url)}
                >
          ...
          <View style={styles.customUrlRow}>
            <TextInput
              ...
              placeholder="Özel Fotoğraf URL'si ekle..."
              value={customUrl}
