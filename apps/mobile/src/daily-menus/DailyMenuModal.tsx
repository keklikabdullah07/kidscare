...
export function DailyMenuModal({ date, visible, onClose }: Props): React.ReactElement {
              ...
              <View style={styles.content}>
                ...
                {warnings.length > 0 && (
                  <View style={styles.warningBox}>
                    ...
                    {warnings.map((w) => (
                      <Text key={w.studentId} style={styles.warningItem}>
                ...
                {/* Breakfast Section */}
                {menu.breakfast.length > 0 && (
                  <View style={[styles.mealCard, styles.breakfastCard]}>
                ...
                {/* Snack Section */}
                {menu.snack.length > 0 && (
                  <View style={[styles.mealCard, styles.snackCard]}>
                    <View style={styles.mealHeader}>
                      <Text style={styles.mealEmoji}>🥪</Text>
