...
export function StudentPassportModal({
  ...
  function addCustomAllergy(): void {
    if (!customAllergy.trim() || allergies.includes(customAllergy.trim())) return;
            ...
            >
              ...
              {!isEditing ? (
                ...
                <View style={styles.sectionContainer}>
                  ...
                  {/* Allergies Card */}
                  <View
                    style={[styles.card, { borderColor: '#FECACA', backgroundColor: '#FEF2F2' }]}
                  >
                    ...
                    {allergies.length > 0 ? (
                      ...
                      <Text style={styles.mutedText}>Kayıtlı alerji yok.</Text>
                    )}
                  </View>
                  ...
                  <View style={styles.card}>
                    ...
                    {emergencyContacts.length > 0 ? (
                      ...
                      <Text style={styles.mutedText}>Acil durum kişisi eklenmedi.</Text>
                    )}
                  </View>
                ...
                <View style={styles.sectionContainer}>
                  ...
                  <View style={styles.tagWrap}>
                    {BLOOD_TYPES.map((bt) => (
                      <Pressable
                        key={bt}
                        style={[styles.choiceBtn, bloodType === bt && styles.choiceBtnActive]}
                  ...
                  <View style={styles.tagWrap}>
                    {QUICK_ALLERGIES.map((qa) => {
                      ...
                      return (
                        <Pressable
                          key={qa}
                          style={[styles.choiceBtn, sel && styles.allergyBtnActive]}
                          onPress={() => toggleAllergy(qa)}
                        >
                  ...
                  <View style={styles.contactAddBox}>
                    ...
                    <TextInput
                      ...
                      placeholder="Yakınlık (Anne, Baba vb.)"
                    />
                    <TextInput
                      style={styles.textInput}
                      value={cPhone}
                  ...
                  <TextInput
                    ...
                    multiline
                    numberOfLines={3}
                    placeholder="Uyku, beslenme veya pedagojik özel notlar..."
                  />
