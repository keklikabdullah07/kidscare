...
5c5a1fc fix(workspace): pin @nx/jest and @nx/eslint to v19 to match nx@19.8.14
ed9d254 feat(tenant-context): AsyncLocalStorage wrapper with runWithTenant helper

=== git diff --stat ===
package.json | 5 +
packages/tenant-context/jest.config.ts | 9 +
packages/tenant-context/package.json | 10 +
packages/tenant-context/project.json | 14 +
packages/tenant-context/src/index.ts | 2 +
packages/tenant-context/src/run-with-tenant.ts | 5 +
packages/tenant-context/src/tenant-context.spec.ts | 21 +
packages/tenant-context/src/tenant-context.ts | 9 +
packages/tenant-context/tsconfig.json | 5 +
pnpm-lock.yaml | 6270 ++++++++++++++++++--
10 files changed, 5866 insertions(+), 484 deletions(-)

=== git diff -U10 ===
diff --git a/package.json b/package.json
index 52dde1e..65abc03 100644
--- a/package.json
+++ b/package.json
@@ -18,21 +18,26 @@
...
- "ts-jest": "^29.4.12",
  ...
  diff --git a/packages/tenant-context/jest.config.ts b/packages/tenant-context/jest.config.ts
  new file mode 100644
  index 0000000..5a81ff6
  --- /dev/null
  +++ b/packages/tenant-context/jest.config.ts
  @@ -0,0 +1,9 @@
...
- }
  +}
  diff --git a/packages/tenant-context/project.json b/packages/tenant-context/project.json
  new file mode 100644
  index 0000000..cf76c86
  --- /dev/null
  +++ b/packages/tenant-context/project.json
  @@ -0,0 +1,14 @@
  +{
- "name": "tenant-context",
...
- "tags": ["scope:shared"]
  ...
  diff --git a/packages/tenant-context/src/run-with-tenant.ts b/packages/tenant-context/src/run-with-tenant.ts
  new file mode 100644
  index 0000000..4577eac
  --- /dev/null
  +++ b/packages/tenant-context/src/run-with-tenant.ts
  @@ -0,0 +1,5 @@
...
- return tenantContext.run(value, fn);
  +}
  diff --git a/packages/tenant-context/src/tenant-context.spec.ts b/packages/tenant-context/src/tenant-context.spec.ts
  new file mode 100644
  index 0000000..d4b6e66
  --- /dev/null
  +++ b/packages/tenant-context/src/tenant-context.spec.ts
  @@ -0,0 +1,21 @@
...
- });
  +});
  diff --git a/packages/tenant-context/src/tenant-context.ts b/packages/tenant-context/src/tenant-context.ts
  new file mode 100644
  index 0000000..1e98728
  --- /dev/null
  +++ b/packages/tenant-context/src/tenant-context.ts
  @@ -0,0 +1,9 @@
  +import { AsyncLocalStorage } from 'node:async_hooks';
-
...
-      '@nx/eslint':
-        specifier: ^19.0.0
-        version: 19.8.14(@babel/traverse@7.29.8)(@types/node@20.19.43)(@zkochan/js-yaml@0.0.7)(eslint@9.39.5)(nx@19.8.14)
-      '@nx/jest':
-        specifier: ^19.8.14
-        version: 19.8.14(@babel/traverse@7.29.8)(@types/node@20.19.43)(babel-plugin-macros@3.1.0)(nx@19.8.14)(ts-node@10.9.1(@types/node@20.19.43)(typescript@5.9.3))(typescript@5.9.3)
-      '@types/jest':
-        specifier: ^30.0.0
-        version: 30.0.0
       '@types/node':
...
-
- '@nrwl/jest@19.8.14':
- resolution: {integrity: sha512-4xW9aRhDnTgsuVuhex+cM6u65XNpc1l3HzJRClaKfJY9cRp2uRpBR6UCgqRypXacflX2QXGczlBBUg2N6CQZ0A==}
-
- '@nrwl/js@19.8.14':
- resolution: {integrity: sha512-DilRYVrqoecsNOkV2j4QDvcIjJXaO2krV7bbfGU/9TSmDzNcdB1R++dEgpa0seo2FrEfVgKffOl/6zzi8PhsgQ==}
-
- '@nrwl/tao@19.8.14':
- resolution: {integrity: sha512-zBeYzzwg43T/Z8ZtLblv0fcKuqJULttqYDekSLILThXp3UOMSerEvruhUgwddCY1jUssfLscz8vacMKISv5X4w==}
- hasBin: true
...
- resolution: {integrity: sha512-I4eZtnHMkqnmOXVy6yN59fQopQZ+Sg0OFWwGluhKD5XPZULrlzECB8d4vblY9pcmQlN/6fat+KBrWkmKl41ZKg==}
-
- '@nx/devkit@19.8.14':
...
-
- '@nx/eslint@19.8.14':
- resolution: {integrity: sha512-fhrCd8OZue7WcIoU4NyKLLrfolEa2TvSgaLxjDabONqZOJRG38Y7ZX92P+Y1hSEdDZ9AazzirIdsy2d1AZWvfQ==}
- peerDependencies:
...
-
- '@nx/jest@19.8.14':
- resolution: {integrity: sha512-y/ce61yDu5qUP4a70OKBlCC5MOFcpS1J8HEJB1DAsF0jFb1NX8ft1B+7LjuGvSbuEmuy+a/pZwiTToUFnp0bGg==}
-
- '@nx/js@19.8.14':
- resolution: {integrity: sha512-Nk0eEB2F/ZbBkH2iT+cgLWIittY8n5eOrA/uBBG2XMdencJZ9E2HNA/UzSGPZmD4EYVk0R1vm83k5+IMS1VAZA==}
- peerDependencies:
-      verdaccio: ^5.0.4
- peerDependenciesMeta:
-      verdaccio:
...
-
- '@nx/linter@19.8.14':
- resolution: {integrity: sha512-QIeEXmdvXKX6rHIiA3W77l2oB9rABH3HYP6bgNaHyx65+tZ6RvmKfVXk+GWMgTf0lfQpnGyI/M7nsa91RGxu6w==}
-
- '@nx/nx-darwin-arm64@19.8.14':
- resolution: {integrity: sha512-bZUFf23gAzuwVw71dR8rngye5aCR8Z/ouIo+KayjqB0LWWoi3WzO73s4S69ljftYt4n6z9wvD+Trbb1BKm2fPg==}
- engines: {node: '>= 10'}
...
- resolution: {integrity: sha512-Yb3d5WVjCyLill8MycKU+P/kbTyatKKqoUCu5zWokkysABiMWRLlrCYNzqwjTjeIIGj9MMGRHAQEemkBdL4tdg==}
-
...
*      slash: 3.0.0
*
* '@jest/core@30.5.1(babel-plugin-macros@3.1.0)(ts-node@10.9.1(@types/node@20.19.43)(typescript@5.9.3))':
* dependencies:
*      '@jest/console': 30.5.1
*      '@jest/pattern': 30.5.0
*      '@jest/reporters': 30.5.1
...
*      graceful-fs: 4.2.11
*      jest-changed-files: 30.5.1
*      jest-config: 30.5.1(@types/node@20.19.43)(babel-plugin-macros@3.1.0)(ts-node@10.9.1(@types/node@20.19.43)(typescript@5.9.3))
*      jest-haste-map: 30.5.1
*      jest-message-util: 30.5.1
*      jest-regex-util: 30.5.0
*      jest-resolve: 30.5.1
...
*      fastq: 1.20.3
*
* '@nrwl/devkit@19.8.14(nx@19.8.14)':
* dependencies:
*      '@nx/devkit': 19.8.14(nx@19.8.14)
* transitivePeerDependencies:
*      - nx
*
* '@nrwl/jest@19.8.14(@babel/traverse@7.29.8)(@types/node@20.19.43)(babel-plugin-macros@3.1.0)(nx@19.8.14)(ts-node@10.9.1(@types/node@20.19.43)(typescript@5.9.3))(typescript@5.9.3)':
* dependencies:
*      '@nx/jest': 19.8.14(@babel/traverse@7.29.8)(@types/node@20.19.43)(babel-plugin-macros@3.1.0)(nx@19.8.14)(ts-node@10.9.1(@types/node@20.19.43)(typescript@5.9.3))(typescript@5.9.3)
* transitivePeerDependencies:
*      - '@babel/traverse'
*      - '@swc-node/register'
*      - '@swc/core'
...
*      - verdaccio
*
* '@nrwl/js@19.8.14(@babel/traverse@7.29.8)(@types/node@20.19.43)(nx@19.8.14)(typescript@5.4.5)':
* dependencies:
*      '@nx/js': 19.8.14(@babel/traverse@7.29.8)(@types/node@20.19.43)(nx@19.8.14)(typescript@5.4.5)
* transitivePeerDependencies:
*      - '@babel/traverse'
*      - '@swc-node/register'
*      - '@swc/core'
...
*      - verdaccio
*
* '@nrwl/js@19.8.14(@babel/traverse@7.29.8)(@types/node@20.19.43)(nx@19.8.14)(typescript@5.9.3)':
* dependencies:
*      '@nx/js': 19.8.14(@babel/traverse@7.29.8)(@types/node@20.19.43)(nx@19.8.14)(typescript@5.9.3)
* transitivePeerDependencies:
*      - '@babel/traverse'
*      - '@swc-node/register'
*      - '@swc/core'
...
*      yargs-parser: 21.1.1
*
* '@nx/eslint@19.8.14(@babel/traverse@7.29.8)(@types/node@20.19.43)(@zkochan/js-yaml@0.0.7)(eslint@9.39.5)(nx@19.8.14)':
* dependencies:
*      '@nx/devkit': 19.8.14(nx@19.8.14)
*      '@nx/js': 19.8.14(@babel/traverse@7.29.8)(@types/node@20.19.43)(nx@19.8.14)(typescript@5.4.5)
*      '@nx/linter': 19.8.14(@babel/traverse@7.29.8)(@types/node@20.19.43)(@zkochan/js-yaml@0.0.7)(eslint@9.39.5)(nx@19.8.14)
*      eslint: 9.39.5
*      semver: 7.8.5
*      tslib: 2.8.1
*      typescript: 5.4.5
...
*      chalk: 4.1.2
*      identity-obj-proxy: 3.0.0
*      jest-config: 29.7.0(@types/node@20.19.43)(babel-plugin-macros@3.1.0)(ts-node@10.9.1(@types/node@20.19.43)(typescript@5.9.3))
*      jest-resolve: 29.7.0
*      jest-util: 29.7.0
*      minimatch: 9.0.3
*      resolve.exports: 1.1.0
...
*      semver: 7.8.5
*      source-map-support: 0.5.19
*      ts-node: 10.9.1(@types/node@20.19.43)(typescript@5.4.5)
*      tsconfig-paths: 4.2.0
*      tslib: 2.8.1
* transitivePeerDependencies:
*      - '@babel/traverse'
...
*      semver: 7.8.5
*      source-map-support: 0.5.19
*      ts-node: 10.9.1(@types/node@20.19.43)(typescript@5.9.3)
*      tsconfig-paths: 4.2.0
*      tslib: 2.8.1
* transitivePeerDependencies:
*      - '@babel/traverse'
...
*      - supports-color
*
* jest-circus@30.5.1(babel-plugin-macros@3.1.0):
* dependencies:
*      '@jest/environment': 30.5.1
*      '@jest/expect': 30.5.1
*      '@jest/test-result': 30.5.1
...
*      - supports-color
*
* jest-cli@30.5.1(@types/node@20.19.43)(babel-plugin-macros@3.1.0)(ts-node@10.9.1(@types/node@20.19.43)(typescript@5.9.3)):
* dependencies:
*      '@jest/core': 30.5.1(babel-plugin-macros@3.1.0)(ts-node@10.9.1(@types/node@20.19.43)(typescript@5.9.3))
*      '@jest/test-result': 30.5.1
*      '@jest/types': 30.5.1
...
* jest@30.5.1(@types/node@20.19.43)(babel-plugin-macros@3.1.0)(ts-node@10.9.1(@types/node@20.19.43)(typescript@5.9.3)):
  dependencies:
...
* ts-jest@29.4.12(@babel/core@7.29.7)(@jest/transform@30.5.1)(@jest/types@30.5.1)(babel-jest@30.5.1(@babel/core@7.29.7))(jest-util@30.5.1)(jest@30.5.1(@types/node@20.19.43)(babel-plugin-macros@3.1.0)(ts-node@10.9.1(@types/node@20.19.43)(typescript@5.9.3)))(typescript@5.9.3):
* dependencies:
*      bs-logger: 0.2.6
*      fast-json-stable-stringify: 2.1.0
*      handlebars: 4.7.9
